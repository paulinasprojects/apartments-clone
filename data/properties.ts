...
export const properties: Property[] = [
  {
    ...
    phoneNumber: "12534556757",
    website: "www.google.com",
    scores: [
      { type: "Walk", description: "Very Walkable", score: 73 },
      { type: "Bike", description: "Very Bikable", score: 72 },
    ],
    pets: [
      {
        type: "Dog",
    ...
    reviews: [
      ...
      {
        body: "Overall, I really do like living here. The staff is great as well as the living conditions and I also love that residences have access to many different kinds of amenities. The only downside to living here is that we can only have AT&T as their internet provider and I think it would be better if people living here could just choose who they want as their internet provider.",
  ...
  },
  {
    ...
    scores: [
      ...
      { type: "Bike", description: "Very Bikable", score: 84 },
    ],
    stars: 3.5,
    reviews: [
      {
  ...
  },
  {
    ...
    phoneNumber: "13454556757",
    website: "www.google.com",
    scores: [
      { type: "Walk", description: "Very Walkable", score: 74 },
      { type: "Bike", description: "Bikable", score: 60 },
    ],
    stars: 0,
  },
  {
    ...
    phoneNumber: "15674556712",
    website: "www.google.com",
    scores: [
      { type: "Walk", description: "Very Walkable", score: 88 },
      { type: "Bike", description: "Bikable", score: 68 },
    ],
    stars: 1,
    reviews: [
      {
