...
export const AccountScreen = () => {
  ...
  const rentingButtons = [
    ...
    },
    {
      ...
      onPress: () => console.log("navigate to Renal Applications"),
    },
    {
      label: "My Residences",
      onPress: () => navigation.navigate("MyProperties"),
    ...
    {
      label: "My Payments",
      onPress: () => console.log("navigate to my Rent Payments"),
    },
  ];
            ...
            <>
              ...
              <View style={styles.middleContainer}>
                <Text category={"s1"} style={styles.subHeader}>
                  Are you a property owner or a manager?
                </Text>
