...
import { PHOTOS_STR, AMENITIES_STR, DESCRIPTION_STR } from "../../constants";
import { TempApartment } from "../../types/temApartments";
...
export const UnitsInput = ({
  ...
  const addUnit = () => {
    ...
    if (newApartments.length > 1 && unitType !== "multiple") {
